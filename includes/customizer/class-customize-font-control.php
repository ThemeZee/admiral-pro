...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Admiral_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct($manager, $id, $args = array(), $options = array()) {
			...
			$this->l10n = array(
				'previous' =>	__( 'Previous Font', 'admiral-pro' ),
				'next' =>		__( 'Next Font', 'admiral-pro' ),
				'standard' =>	_x( 'Default', 'default font button', 'admiral-pro' )
			);
			...
			// Set Fonts
			$this->fonts = Admiral_Pro_Custom_Font_Lists::get_fonts($theme_options['available_fonts']);
