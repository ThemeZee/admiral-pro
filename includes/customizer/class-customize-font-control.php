...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Admiral_Pro_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'admiral_pro_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'admiral-pro' ),
				'next'     => esc_html__( 'Next Font', 'admiral-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'admiral-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Admiral_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Admiral_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'admiral-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'admiral-pro' ); ?>">
	  							<?php
