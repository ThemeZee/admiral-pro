...
class Admiral_Pro_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from a selected category in a horizontal box.', 'admiral-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Horizontal Box)', 'admiral-pro' ),
			'category' => 0,
		);
