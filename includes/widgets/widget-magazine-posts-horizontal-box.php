 ...
 */
class Admiral_Pro_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Horizontal Box)', 'admiral' ), // Name.
			array(
				'classname' => 'admiral-magazine-horizontal-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a horizontal box. Please use this widget ONLY in the Magazine Homepage widget area.', 'admiral' ),
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = admiral_get_magazine_post_ids( $this->id, $settings['category'], 4 );
 ...
 * Register Widget
 */
function admiral_register_magazine_posts_horizontal_box_widget() {

	register_widget( 'Admiral_Pro_Magazine_Horizontal_Box_Widget' );

}
add_action( 'widgets_init', 'admiral_register_magazine_posts_horizontal_box_widget' );
