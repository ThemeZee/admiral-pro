...
if ( ! class_exists( 'Admiral_Pro_Post_Meta' ) ) :

class Admiral_Pro_Post_Meta {
	...
	static function post_meta_settings( $wp_customize ) {
		...
		$wp_customize->add_control( new Admiral_Customize_Header_Control(
			$wp_customize, 'admiral_theme_options[postmeta_headline]', array(
				'label' => esc_html__( 'Post Meta', 'admiral-pro' ),
		...
		$wp_customize->add_control( 'admiral_theme_options[meta_date]', array(
			'label'    => esc_html__( 'Display post date', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
		...
		$wp_customize->add_control( 'admiral_theme_options[meta_author]', array(
			'label'    => esc_html__( 'Display post author', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
		...
		$wp_customize->add_control( 'admiral_theme_options[meta_category]', array(
			'label'    => esc_html__( 'Display post categories', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
		...
		$wp_customize->add_setting( 'admiral_theme_options[single_posts_headline]', array(
			'default'           => '',
			'type'           	=> 'option',
			'transport'         => 'refresh',
			'sanitize_callback' => 'esc_attr'
		...
		$wp_customize->add_control( new Admiral_Customize_Header_Control(
			$wp_customize, 'admiral_theme_options[single_posts_headline]', array(
				'label' => esc_html__( 'Single Posts', 'admiral-pro' ),
				'section' => 'admiral_section_post',
				'settings' => 'admiral_theme_options[single_posts_headline]',
				'priority' => 8
				)
			)
		);
		
		$wp_customize->add_setting( 'admiral_theme_options[post_image]', array(
			'default'           => true,
			'type'           	=> 'option',
			'transport'         => 'refresh',
			'sanitize_callback' => 'admiral_sanitize_checkbox'
		...
		$wp_customize->add_control( 'admiral_theme_options[post_image]', array(
			'label'    => esc_html__( 'Display featured image on single posts', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
			'settings' => 'admiral_theme_options[post_image]',
			'type'     => 'checkbox',
			'priority' => 9
			)
		);
		...
		$wp_customize->add_control( 'admiral_theme_options[meta_tags]', array(
			'label'    => esc_html__( 'Display post tags on single posts', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
		...
		$wp_customize->add_control( 'admiral_theme_options[post_navigation]', array(
			'label'    => esc_html__( 'Display post navigation on single posts', 'admiral-pro' ),
			'section'  => 'admiral_section_post',
...
// Run Class
add_action( 'init', array( 'Admiral_Pro_Post_Meta', 'setup' ) );
